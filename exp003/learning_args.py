...
def parse_args():
    ...
    arg_parser.add_argument('--train_dir', default='/home/yi/Downloads/youtube-64')
    arg_parser.add_argument('--test_dir', default='/home/yi/Downloads/youtube-64')
    arg_parser.add_argument('--test_video', action='store_true')
    arg_parser.add_argument('--flow_dir', default='/home/yi/Downloads/youtube-64-flow')
    arg_parser.add_argument('--flow_video_dir', default='/home/yi/Downloads/youtube-64-flow-video')
