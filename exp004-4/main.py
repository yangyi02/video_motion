...
from models import FullyConvNet, FullyConvResNet, UNet, UNetBidirection, UNetBidirection2, UNetBidirection3, DilateResNetBidirection
...
def train_unsupervised(args, model, m_kernel, reverse_m_dict):
    ...
    for epoch in range(args.train_epoch):
        ...
        if torch.cuda.is_available():
            ...
            ones = ones.cuda()
        im_pred, m_mask_f, attn_f, m_mask_b, attn_b = model(im_input_f, im_input_b, ones)
...
def test_unsupervised(args, model, m_kernel, reverse_m_dict):
    ...
    for epoch in range(args.test_epoch):
        ...
        if args.display:
            ...
            visualize(im_input_f, im_input_b, im_output, im_pred, flow_f, attn_f, flow_b, attn_b)
