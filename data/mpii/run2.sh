...
python split_folder.py --image_size=240 --split_dir=/home/yi/Downloads/$NEW_NAME --split_round=2 --meta_file=./$NAME/meta.pkl --second_meta_file=./$NAME/meta_2.pkl --image_diff_file=./$NAME/diff.txt --discontinue_file=./$NAME/discontinue.txt
