...
class DilateResNet(nn.Module):
    def __init__(self, im_height, im_width, im_channel, n_class):
        ...
        self.conv0 = nn.Conv2d(im_channel, num_hidden, 3, 1, 1)
        self.bn0 = nn.BatchNorm2d(num_hidden)
        self.conv1_1 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 2, 2)
        self.bn1_1 = nn.BatchNorm2d(num_hidden)
        self.conv1_2 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 1)
        self.bn1_2 = nn.BatchNorm2d(num_hidden)
        self.conv2_1 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 2, 2)
        self.bn2_1 = nn.BatchNorm2d(num_hidden)
        self.conv2_2 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 1)
        self.bn2_2 = nn.BatchNorm2d(num_hidden)
        self.conv3_1 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 2, 2)
        self.bn3_1 = nn.BatchNorm2d(num_hidden)
        self.conv3_2 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 1)
        self.bn3_2 = nn.BatchNorm2d(num_hidden)
        self.conv4_1 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 2, 2)
        self.bn4_1 = nn.BatchNorm2d(num_hidden)
        self.conv4_2 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 1)
        self.bn4_2 = nn.BatchNorm2d(num_hidden)
        self.conv5_1 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 2, 2)
        self.bn5_1 = nn.BatchNorm2d(num_hidden)
        self.conv5_2 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 1)
        self.bn5_2 = nn.BatchNorm2d(num_hidden)
        self.conv6_1 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 2, 2)
        self.bn6_1 = nn.BatchNorm2d(num_hidden)
        self.conv6_2 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 1)
        self.bn6_2 = nn.BatchNorm2d(num_hidden)
        self.conv7_1 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 2, 2)
        ...
        self.conv8_1 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 2, 2)
        ...
        self.conv9_1 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 2, 2)
        ...
        self.conv10_1 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 2, 2)
    ...
    def forward(self, x):
        ...
        y = F.relu(self.bn6_1(self.conv6_1(x)))
        x = F.relu(self.bn6_2(self.conv6_2(y) + x))
        y = F.relu(self.bn7_1(self.conv7_1(x)))
        x = F.relu(self.bn7_2(self.conv7_2(y) + x))
        y = F.relu(self.bn8_1(self.conv8_1(x)))
        x = F.relu(self.bn8_2(self.conv8_2(y) + x))
        y = F.relu(self.bn9_1(self.conv9_1(x)))
        x = F.relu(self.bn9_2(self.conv9_2(y) + x))
        y = F.relu(self.bn10_1(self.conv10_1(x)))
        x = F.relu(self.bn10_2(self.conv10_2(y) + x))
        motion = self.conv(x)
        return motion


class DilateResNet2(nn.Module):
    def __init__(self, im_height, im_width, im_channel, n_class):
        super(DilateResNet2, self).__init__()
        num_hidden = 64
        self.conv0 = nn.Conv2d(im_channel, num_hidden, 3, 1, 1)
        self.bn0 = nn.BatchNorm2d(num_hidden)
        self.conv1 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 1)
        ...
        self.conv9_2 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 1)
        self.bn9_2 = nn.BatchNorm2d(num_hidden)
        self.conv10 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 1)
        self.conv10_1 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 2, 2)
        self.bn10_1 = nn.BatchNorm2d(num_hidden)
        self.conv10_2 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 1)
        self.bn10_2 = nn.BatchNorm2d(num_hidden)
        self.conv11 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 1)
        self.conv11_1 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 2, 2)
        ...
        self.conv12 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 1)
        self.conv12_1 = nn.Conv2d(num_hidden, num_hidden, 3, 1, 2, 2)
    ...
    def forward(self, x):
        x = self.bn0(self.conv0(x))
        y = F.relu(self.bn1_1(self.conv1_1(x) + self.conv1(x)))
        x = F.relu(self.bn1_2(self.conv1_2(y) + x))
        y = F.relu(self.bn2_1(self.conv2_1(x) + self.conv2(x)))
        x = F.relu(self.bn2_2(self.conv2_2(y) + x))
        y = F.relu(self.bn3_1(self.conv3_1(x) + self.conv3(x)))
        x = F.relu(self.bn3_2(self.conv3_2(y) + x))
        y = F.relu(self.bn4_1(self.conv4_1(x) + self.conv4(x)))
        x = F.relu(self.bn4_2(self.conv4_2(y) + x))
        y = F.relu(self.bn5_1(self.conv5_1(x) + self.conv5(x)))
        x = F.relu(self.bn5_2(self.conv5_2(y) + x))
        y = F.relu(self.bn6_1(self.conv6_1(x) + self.conv6(x)))
        x = F.relu(self.bn6_2(self.conv6_2(y) + x))
        y = F.relu(self.bn7_1(self.conv7_1(x) + self.conv7(x)))
        x = F.relu(self.bn7_2(self.conv7_2(y) + x))
        y = F.relu(self.bn8_1(self.conv8_1(x) + self.conv8(x)))
        x = F.relu(self.bn8_2(self.conv8_2(y) + x))
        y = F.relu(self.bn9_1(self.conv9_1(x) + self.conv9(x)))
        x = F.relu(self.bn9_2(self.conv9_2(y) + x))
        y = F.relu(self.bn10_1(self.conv10_1(x) + self.conv10(x)))
        x = F.relu(self.bn10_2(self.conv10_2(y) + x))
        y = F.relu(self.bn11_1(self.conv11_1(x) + self.conv11(x)))
        x = F.relu(self.bn11_2(self.conv11_2(y) + x))
        y = F.relu(self.bn12_1(self.conv12_1(x) + self.conv12(x)))
        x = F.relu(self.bn12_2(self.conv12_2(y) + x))
        motion = self.conv(x)
        return motion
