...
def parse_args():
    ...
    arg_parser.add_argument('--train_dir', default='/home/yi/Downloads/mpii-240-2')
    arg_parser.add_argument('--test_dir', default='/home/yi/Downloads/mpii-240-2')
    ...
    arg_parser.add_argument('--output_flow_video_path', default='flow_video')
