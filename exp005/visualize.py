...
def visualize(im_input_f, im_input_b, im_output, pred, pred_motion_f, disappear_f, attn_f, pred_motion_b, disappear_b, attn_b):
    img = visualize_image(im_input_f, im_input_b, im_output, pred, pred_motion_f, disappear_f, attn_f, pred_motion_b, disappear_b, attn_b)
    # plt.figure(1)
    # plt.imshow(img)
    # plt.axis('off')
    # plt.show()
...
def visualize_image(im_input_f, im_input_b, im_output, pred, pred_motion_f, disappear_f, attn_f, pred_motion_b, disappear_b, attn_b):
